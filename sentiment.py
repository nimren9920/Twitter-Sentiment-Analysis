...
# Input for keyword and no. of tweets
# date_since = "2021-01-01"

keyword = input("Enter keyword of hashtag to be searched for: ")
ntweets = int(input("Enter no.of tweets: "))

tweets = tw.Cursor(api.search, q="%s" %keyword, lang="en", tweet_mode='extended').items(ntweets) #from:user #-filter:retweets
